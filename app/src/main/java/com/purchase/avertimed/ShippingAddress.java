...
import com.purchase.avertimed.API.GetShippingAddressRequest;
import com.purchase.avertimed.API.SetShippingAddressRequest;
...
public class ShippingAddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(ShippingAddress.this);//Creating the RequestQueue
        ...
        findViewById(R.id.place_order).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(SH_Name.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter First Name",Toast.LENGTH_SHORT).show();
                }else  if(SH_LastName.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter Last Name",Toast.LENGTH_SHORT).show();
                }else  if(SH_Address_line_1.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter Address Line 1",Toast.LENGTH_SHORT).show();
                }else  if(SH_Address_line_2.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter Address Line 2",Toast.LENGTH_SHORT).show();
                }else  if(SH_State.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter State",Toast.LENGTH_SHORT).show();
                }else  if(SH_Contry.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter Country",Toast.LENGTH_SHORT).show();
                }else  if(SH_PINCode.getText().toString().isEmpty()){
                    Toast.makeText(ShippingAddress.this,"Please Enter Pin Code",Toast.LENGTH_SHORT).show();
                }else  {
        ...
        SetShippingAddressRequest loginRequest1 = new SetShippingAddressRequest(name,last,ad1,ad2,state,contry,pin,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    GetAddress();
                    Toast.makeText(ShippingAddress.this,jsonObject.getString("ResponseMsg"),Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof ServerError)
                    Toast.makeText(ShippingAddress.this, "Server Error", Toast.LENGTH_SHORT).show();
                else if (error instanceof TimeoutError)
                    Toast.makeText(ShippingAddress.this, "Connection Timed Out", Toast.LENGTH_SHORT).show();
                else if (error instanceof NetworkError)
                    Toast.makeText(ShippingAddress.this, "Bad Network Connection", Toast.LENGTH_SHORT).show();
            }
        }){@Override
