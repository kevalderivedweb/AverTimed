...
public class GetAddressIntentService extends IntentService {
   ...
   if (addresses == null || addresses.size() == 0) {
      ...
      userSession.UserAddress(address.getFeatureName(),address.getThoroughfare(),address.getLocality()
              ,address.getSubAdminArea(),address.getAdminArea(),address.getCountryName(),address.getPostalCode());
