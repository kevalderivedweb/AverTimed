...
public class RegistrationRequest extends StringRequest {
    ...
    public RegistrationRequest(String FirstName, String LastName, String Email, String Password, String ConfirmPassword, String currency,String DeviceToken,Response.Listener<String> listener, Response.ErrorListener errorListener) {
